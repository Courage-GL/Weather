...
import com.xiaoalei.android.library.view.DividerItemDecoration;
...
public class SelectCityFragment extends BaseFragment implements SelectCityContract.View {
    ...
    @BindView(com.xiaoalei.android.weather.R.id.rv_city_list)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(com.xiaoalei.android.weather.R.layout.fragment_select_city, container, false);
