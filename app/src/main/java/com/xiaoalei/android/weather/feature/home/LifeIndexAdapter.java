...
import com.xiaoalei.android.weather.base.BaseRecyclerViewAdapter;
...
public class LifeIndexAdapter extends BaseRecyclerViewAdapter<LifeIndexAdapter.ViewHolder> {
    ...
    public LifeIndexAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(com.xiaoalei.android.weather.R.layout.item_life_index, parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(com.xiaoalei.android.weather.R.id.index_icon_image_view)
        ImageView indexIconImageView;
        @BindView(com.xiaoalei.android.weather.R.id.index_level_text_view)
        TextView indexLevelTextView;
        @BindView(com.xiaoalei.android.weather.R.id.index_name_text_view)
    ...
    private Drawable getIndexDrawable(Context context, String indexName) {
        ...
        int colorResourceId = com.xiaoalei.android.weather.R.drawable.ic_index_sunscreen;
        if (indexName.contains("防晒")) {
            colorResourceId = com.xiaoalei.android.weather.R.drawable.ic_index_sunscreen;
        } else if (indexName.contains("穿衣")) {
            colorResourceId = com.xiaoalei.android.weather.R.drawable.ic_index_dress;
        } else if (indexName.contains("运动")) {
            colorResourceId = com.xiaoalei.android.weather.R.drawable.ic_index_sport;
        } else if (indexName.contains("逛街")) {
            colorResourceId = com.xiaoalei.android.weather.R.drawable.ic_index_shopping;
        } else if (indexName.contains("晾晒")) {
            colorResourceId = com.xiaoalei.android.weather.R.drawable.ic_index_sun_cure;
        } else if (indexName.contains("洗车")) {
            colorResourceId = com.xiaoalei.android.weather.R.drawable.ic_index_car_wash;
        } else if (indexName.contains("感冒")) {
            colorResourceId = com.xiaoalei.android.weather.R.drawable.ic_index_clod;
        } else if (indexName.contains("广场舞")) {
            colorResourceId = com.xiaoalei.android.weather.R.drawable.ic_index_dance;
        }
