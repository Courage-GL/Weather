...
public class ForecastAdapter extends BaseRecyclerViewAdapter<ForecastAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(com.xiaoalei.android.weather.R.layout.item_forecast, parent, false);
    ...
    public void onBindViewHolder(ForecastAdapter.ViewHolder holder, int position) {
        ...
        holder.weatherIconImageView.setImageResource(com.xiaoalei.android.weather.R.mipmap.ic_launcher);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(com.xiaoalei.android.weather.R.id.week_text_view)
        TextView weekTextView;
        @BindView(com.xiaoalei.android.weather.R.id.date_text_view)
        TextView dateTextView;
        @BindView(com.xiaoalei.android.weather.R.id.weather_icon_image_view)
        ImageView weatherIconImageView;
        @BindView(com.xiaoalei.android.weather.R.id.weather_text_view)
        TextView weatherTextView;
        @BindView(com.xiaoalei.android.weather.R.id.temp_max_text_view)
        TextView tempMaxTextView;
        @BindView(com.xiaoalei.android.weather.R.id.temp_min_text_view)
