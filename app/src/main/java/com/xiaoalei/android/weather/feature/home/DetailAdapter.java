...
public class DetailAdapter extends BaseRecyclerViewAdapter<DetailAdapter.ViewHolder> {
    ...
    public DetailAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(com.xiaoalei.android.weather.R.layout.item_detail, parent, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(com.xiaoalei.android.weather.R.id.detail_icon_image_view)
        ImageView detailIconImageView;
        @BindView(com.xiaoalei.android.weather.R.id.detail_key_text_view)
        TextView detailKeyTextView;
        @BindView(com.xiaoalei.android.weather.R.id.detail_value_text_view)
