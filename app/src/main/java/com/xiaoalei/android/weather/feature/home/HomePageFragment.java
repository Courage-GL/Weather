...
import com.xiaoalei.android.weather.base.BaseFragment;
import com.xiaoalei.android.weather.data.db.entities.minimalist.AirQualityLive;
import com.xiaoalei.android.weather.data.db.entities.minimalist.WeatherForecast;
import com.xiaoalei.android.weather.data.db.entities.minimalist.LifeIndex;
import com.xiaoalei.android.weather.data.db.entities.minimalist.Weather;
import com.xiaoalei.android.weather.data.WeatherDetail;
import com.xiaoalei.android.widget.IndicatorView;
...
public class HomePageFragment extends BaseFragment implements HomePageContract.View {
    ...
    //AQI
    @BindView(com.xiaoalei.android.weather.R.id.tv_aqi)
    TextView aqiTextView;
    @BindView(com.xiaoalei.android.weather.R.id.tv_quality)
    TextView qualityTextView;
    @BindView(com.xiaoalei.android.weather.R.id.indicator_view_aqi)
    IndicatorView aqiIndicatorView;
    @BindView(com.xiaoalei.android.weather.R.id.tv_advice)
    TextView adviceTextView;
    @BindView(com.xiaoalei.android.weather.R.id.tv_city_rank)
    TextView cityRankTextView;

    //详细天气信息
    @BindView(com.xiaoalei.android.weather.R.id.detail_recycler_view)
    RecyclerView detailRecyclerView;

    //预报
    @BindView(com.xiaoalei.android.weather.R.id.forecast_recycler_view)
    RecyclerView forecastRecyclerView;

    //生活指数
    @BindView(com.xiaoalei.android.weather.R.id.life_index_recycler_view)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(com.xiaoalei.android.weather.R.layout.fragment_home_page, container, false);
    ...
    private List<WeatherDetail> createDetails(Weather weather) {
        ...
        details.add(new WeatherDetail(com.xiaoalei.android.weather.R.drawable.ic_index_sunscreen, "体感温度", weather.getWeatherLive().getFeelsTemperature() + "°C"));
        details.add(new WeatherDetail(com.xiaoalei.android.weather.R.drawable.ic_index_sunscreen, "湿度", weather.getWeatherLive().getHumidity() + "%"));
//        details.add(new WeatherDetail(R.drawable.ic_index_sunscreen, "气压", (int) Double.parseDouble(weather.getWeatherLive().getAirPressure()) + "hPa"));
        details.add(new WeatherDetail(com.xiaoalei.android.weather.R.drawable.ic_index_sunscreen, "紫外线指数", weather.getWeatherForecasts().get(0).getUv()));
        details.add(new WeatherDetail(com.xiaoalei.android.weather.R.drawable.ic_index_sunscreen, "降水量", weather.getWeatherLive().getRain() + "mm"));
        details.add(new WeatherDetail(com.xiaoalei.android.weather.R.drawable.ic_index_sunscreen, "降水概率", weather.getWeatherForecasts().get(0).getPop() + "%"));
        details.add(new WeatherDetail(com.xiaoalei.android.weather.R.drawable.ic_index_sunscreen, "能见度", weather.getWeatherForecasts().get(0).getVisibility() + "km"));
        return details;
    }
